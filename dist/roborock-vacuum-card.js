function t(t, e, o, i) {
    var s, r = arguments.length,
        n = r < 3 ? e : null === i ? i = Object.getOwnPropertyDescriptor(e, o) : i;
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) n = Reflect.decorate(t, e, o, i);
    else
        for (var a = t.length - 1; a >= 0; a--)(s = t[a]) && (n = (r < 3 ? s(n) : r > 3 ? s(e, o, n) : s(e, o)) || n);
...
class r {
    ...
    get styleSheet() {
        ...
        if (o && void 0 === t) {
            ...
            o && (t = s.get(e)), void 0 === t && ((this.o = t = new CSSStyleSheet).replaceSync(this.cssText), o && s.set(e, t))
        }
        return t
    }
    toString() {
...
class w extends HTMLElement {
    ...
    static getPropertyDescriptor(t, e, o) {
        ...
        return {
            ...
            set(e) {
                const r = i?.call(this);
                s.call(this, e), this.requestUpdate(t, r, o)
            },
            configurable: !0,
            enumerable: !0
        }
    ...
    static finalizeStyles(t) {
        ...
        if (Array.isArray(t)) {
            ...
            for (const t of o) e.unshift(a(t))
    ...
    createRenderRoot() {
        ...
        return ((t, i) => {
            if (o) t.adoptedStyleSheets = i.map((t => t instanceof CSSStyleSheet ? t : t.styleSheet));
            else
                for (const o of i) {
                    const i = document.createElement("style"),
                        s = e.litNonce;
                    void 0 !== s && i.setAttribute("nonce", s), i.textContent = o.cssText, t.appendChild(i)
                }
    ...
    _$EC(t, e) {
        ...
        if (void 0 !== i && !0 === o.reflect) {
            ...
            this._$Em = t, null == s ? this.removeAttribute(i) : this.setAttribute(i, s), this._$Em = null
        }
    }
    _$AK(t, e) {
        ...
        if (void 0 !== i && this._$Em !== i) {
            ...
            this._$Em = i, this[i] = s.fromAttribute(e, t.type), this._$Em = null
        }
    }
    requestUpdate(t, e, o) {
        if (void 0 !== t) {
            if (o ??= this.constructor.getPropertyOptions(t), !(o.hasChanged ?? b)(this[t], e)) return;
            this.P(t, e, o)
        }!1 === this.isUpdatePending && (this._$ES = this._$ET())
    }
    P(t, e, o) {
        this._$AL.has(t) || this._$AL.set(t, e), !0 === o.reflect && this._$Em !== t && (this._$Ej ??= new Set).add(t)
    }
    async _$ET() {
    ...
    performUpdate() {
        ...
        if (!this.hasUpdated) {
            ...
            if (t.size > 0)
                for (const [e, o] of t) !0 !== o.wrapped || this._$AL.has(e) || void 0 === this[e] || this.P(e, this[e], o)
        }
        let t = !1;
        const e = this._$AL;
        try {
...
w.elementStyles = [], w.shadowRootOptions = {
    mode: "open"
}, w[f("elementProperties")] = new Map, w[f("finalized")] = new Map, _?.({
    ReactiveElement: w
...
const K = (t, e) => {
    ...
    for (let e = 0; e < o; e++) {
        ...
        let a, c, l = -1,
            d = 0;
        for (; d < o.length && (n.lastIndex = d, c = n.exec(o), null !== c);) d = n.lastIndex, n === B ? "!--" === c[1] ? n = T : void 0 !== c[1] ? n = U : void 0 !== c[2] ? (H.test(c[2]) && (s = RegExp("</" + c[2], "g")), n = V) : void 0 !== c[3] && (n = V) : n === V ? ">" === c[0] ? (n = s ?? B, l = -1) : void 0 === c[1] ? l = -2 : (l = n.lastIndex - c[2].length, a = c[1], n = void 0 === c[3] ? V : '"' === c[3] ? I : N) : n === I || n === N ? n = V : n === T || n === U ? n = B : (n = V, s = void 0);
        const p = n === V && t[e + 1].startsWith("/>") ? " " : "";
        r += n === B ? o + z : l >= 0 ? (i.push(a), o.slice(0, l) + A + o.slice(l) + S + p) : o + S + (-2 === l ? e : p)
    }
...
class Q {
    constructor({
        ...
        const n = t.length - 1,
            a = this.parts,
            [c, l] = K(t, e);
        if (this.el = Q.createElement(c, o), Z.currentNode = this.el.content, 2 === e) {
            ...
            if (1 === i.nodeType) {
                ...
                if (H.test(i.tagName)) {
                    ...
                    if (e > 0) {
                        ...
                        for (let o = 0; o < e; o++) i.append(t[o], P()), Z.nextNode(), a.push({
                            type: 2,
                            index: ++s
                        });
                        i.append(t[e], P())
                ...
                if (i.data === C) a.push({
                    ...
                    let t = -1;
                    for (; - 1 !== (t = i.data.indexOf(S, t + 1));) a.push({
                        type: 7,
                        index: s
                    }), t += S.length - 1
                } s++
...
function J(t, e, o = t, i) {
    ...
    return s?.constructor !== r && (s?._$AO?.(!1), void 0 === r ? s = void 0 : (s = new r(t), s._$AT(t, o, i)), void 0 !== i ? (o._$Co ??= [])[i] = s : o._$Cl = s), void 0 !== s && (e = J(t, s._$AS(t, e.values), s, i)), e
}
class G {
    constructor(t, e) {
    ...
    u(t) {
        const {
            ...
            parts: o
        } = this._$AD, i = (t?.creationScope ?? E).importNode(e, !0);
        Z.currentNode = i;
        let s = Z.nextNode(),
            r = 0,
            n = 0,
        ...
        for (; void 0 !== a;) {
            if (r === a.index) {
                let e;
                2 === a.type ? e = new X(s, s.nextSibling, this, t) : 1 === a.type ? e = new a.ctor(s, a.name, a.strings, this, t) : 6 === a.type && (e = new it(s, this, t)), this._$AV.push(e), a = o[++n]
            }
            r !== a?.index && (s = Z.nextNode(), r++)
        }
        return Z.currentNode = E, i
    }
    p(t) {
        let e = 0;
...
class X {
    ...
    constructor(t, e, o, i) {
        this.type = 2, this._$AH = W, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = o, this.options = i, this._$Cv = i?.isConnected ?? !0
    }
    get parentNode() {
    ...
    _$AI(t, e = this) {
        t = J(this, t, e), R(t) ? t === W || null == t || "" === t ? (this._$AH !== W && this._$AR(), this._$AH = W) : t !== this._$AH && t !== L && this._(t) : void 0 !== t._$litType$ ? this.$(t) : void 0 !== t.nodeType ? this.T(t) : (t => j(t) || "function" == typeof t?.[Symbol.iterator])(t) ? this.k(t) : this._(t)
    }
    S(t) {
    ...
    $(t) {
        const {
            values: e,
            _$litType$: o
        } = t, i = "number" == typeof o ? this._$AC(t) : (void 0 === o.el && (o.el = Q.createElement(F(o.h, o.h[0]), this.options)), o);
    ...
    _$AC(t) {
        ...
        return void 0 === e && q.set(t.strings, e = new Q(t)), e
    }
    k(t) {
        j(this._$AH) || (this._$AH = [], this._$AR());
        const e = this._$AH;
        let o, i = 0;
        for (const s of t) i === e.length ? e.push(o = new X(this.S(P()), this.S(P()), this, this.options)) : o = e[i], o._$AI(s), i++;
...
class Y {
    ...
    constructor(t, e, o, i, s) {
        this.type = 1, this._$AH = W, this._$AN = void 0, this.element = t, this.name = e, this._$AM = i, this.options = s, o.length > 2 || "" !== o[0] || "" !== o[1] ? (this._$AH = Array(o.length - 1).fill(new String), this.strings = o) : this._$AH = W
    }
    _$AI(t, e = this, o, i) {
        const s = this.strings;
        let r = !1;
        if (void 0 === s) t = J(this, t, e, 0), r = !R(t) || t !== this._$AH && t !== L, r && (this._$AH = t);
        else {
            const i = t;
            let n, a;
            for (t = s[0], n = 0; n < s.length - 1; n++) a = J(this, i[o + n], e, n), a === L && (a = this._$AH[n]), r ||= !R(a) || a !== this._$AH[n], a === W ? t = W : t !== W && (t += (a ?? "") + s[n + 1]), this._$AH[n] = a
        }
        r && !i && this.j(t)
    }
    j(t) {
...
st?.(Q, X), (k.litHtmlVersions ??= []).push("3.1.2");
class rt extends w {
    constructor() {
...
rt._$litElement$ = !0, rt.finalized = !0, globalThis.litElementHydrateSupport?.({
    LitElement: rt
});
...
const at = t => (e, o) => {
    ...
    lt = (t = ct, e, o) => {
        ...
        if (void 0 === r && globalThis.litPropertyMetadata.set(s, r = new Map), r.set(o.name, t), "accessor" === i) {
            const {
                name: i
            } = o;
            return {
                set(o) {
                    ...
                    e.set.call(this, o), this.requestUpdate(i, s, t)
                },
                init(e) {
        ...
        if ("setter" === i) {
            ...
            return function(o) {
                const s = this[i];
                e.call(this, o), this.requestUpdate(i, s, t)
            }
        }
...
function dt(t) {
    return (e, o) => "object" == typeof o ? lt(t, e, o) : ((t, e, o) => {
        ...
        return e.constructor.createProperty(o, i ? {
            ...t,
            wrapped: !0
        } : t), i ? Object.getOwnPropertyDescriptor(e, o) : void 0
    })(t, e, o)
}
...
function mt(t, e) {
    ...
    if (t && "undefined" != typeof document) {
        ...
        s.type = "text/css", "top" === o && i.firstChild ? i.insertBefore(s, i.firstChild) : i.appendChild(s), s.styleSheet ? s.styleSheet.cssText = t : s.appendChild(document.createTextNode(t))
    }
}
...
function It(t, e, o) {
    ...
    if (void 0 === c && (c = r), void 0 !== c) return e && o && (c = null == c ? void 0 : c.replace(e, o)), c
}
var Ht, Dt, Lt, Wt;
! function(t) {
    t.VacAndMop = "vac&mop", t.Mop = "mop", t.Vac = "vac"
}(Ht || (Ht = {})),
function(t) {
    t.Off = "off", t.Quiet = "quiet", t.Balanced = "balanced", t.Turbo = "turbo", t.Max = "max", t.MaxPlus = "max_plus"
}(Dt || (Dt = {})),
function(t) {
    t.Off = "off", t.Mild = "mild", t.Moderate = "moderate", t.Intense = "intense"
}(Lt || (Lt = {})),
function(t) {
    t.Fast = "fast", t.Standard = "standard", t.Deep = "deep", t.DeepPlus = "deep_plus"
}(Wt || (Wt = {}));
class qt {
    get name() {
    ...
    static isSupportedMopMode(t, e) {
        switch (e) {
            case Ht.VacAndMop:
            case Ht.Mop:
                return [Lt.Mild, Lt.Moderate, Lt.Intense].includes(t);
            case Ht.Vac:
                return t == Lt.Off
        }
    }
...
let Gt = class extends rt {
    ...
    connectedCallback() {
        super.connectedCallback(), this.buttons.forEach((t => this.selection[t.value] = !1))
    }
    render() {
        if (!this.buttons) return W;
        const t = this.buttons.map((({
            icon: t,
            text: e,
            value: o
        }) => {
    ...
    _onItemClick(t) {
        this.selection[t] = !this.selection[t], this.requestUpdate();
...
t([dt()], Gt.prototype, "buttons", void 0), t([pt()], Gt.prototype, "selection", void 0), Gt = t([at("multiselect-button-group")], Gt);
...
let Yt = class extends rt {
    ...
    _onItemClick(t, e) {
        this.active === t || e || (this.active = t, this.dispatchEvent(new CustomEvent("select", {
            detail: t
        })))
    }
};
t([dt()], Yt.prototype, "buttons", void 0), t([dt()], Yt.prototype, "active", void 0), Yt = t([at("segment-button-group")], Yt);
...
let ee = class extends rt {
    constructor() {
        super(...arguments), this.color = "#000"
    }
    static get styles() {
        return te
    }
    connectedCallback() {
        super.connectedCallback(), this.active || (this.active = "1")
    }
    render() {
    ...
    _onItemClick() {
        ...
        t += 1, t > 3 && (t = 1), this.active = t.toString(), this.dispatchEvent(new CustomEvent("select", {
            detail: t
        }))
    }
};
t([dt()], ee.prototype, "active", void 0), t([dt()], ee.prototype, "color", void 0), ee = t([at("cycles-button")], ee);
let oe = class extends rt {
    constructor() {
        super(...arguments), this.areas = [], this.iconColor = "#000", this.popupRequestInProgress = !1, this.activeCleaningMode = Ht.VacAndMop, this.activeSuctionMode = Dt.Turbo, this.activeMopMode = Lt.Moderate, this.activeRouteMode = Wt.Standard, this.activeCycleMode = "1", this.activeAreas = [], this.cleaningModes = [], this.suctionModes = [], this.mopModes = [], this.routeModes = []
    }
    static get styles() {
        return Qt
    }
    connectedCallback() {
        super.connectedCallback(), this.cleaningModes = [{
            ...
            text: It("mode.vac"),
            value: Ht.Vac
        }], this.activeSuctionMode = this.robot.getSuctionMode(), this.activeMopMode = this.robot.getMopMode(), this.activeRouteMode = this.robot.getRouteMode(), this.activeSuctionMode == Dt.Off ? this.activeCleaningMode = Ht.Mop : this.activeMopMode == Lt.Off ? this.activeCleaningMode = Ht.Vac : this.activeCleaningMode = Ht.VacAndMop
    }
    onCleaningModeChange(t) {
        const e = t.detail;
        this.activeCleaningMode = e, this.fixModesIfNeeded()
    }
    ...
    onAreasChange(t) {
        this.activeAreas = t.detail, this.requestUpdate()
    }
    async onRunCleaning() {
        if (0 == this.activeAreas.length) return;
        this.popupRequestInProgress = !0, this.fixModesIfNeeded(), await this.robot.setSuctionModeAsync(this.activeSuctionMode), await new Promise((t => setTimeout(t, 100))), await this.robot.setMopModeAsync(this.activeMopMode), await new Promise((t => setTimeout(t, 100))), await this.robot.setRouteModeAsync(this.activeRouteMode), await new Promise((t => setTimeout(t, 100)));
        const t = this.activeAreas.map((t => parseInt(t, 10)));
        await this.robot.startSegmentsCleaningAsync(t, parseInt(this.activeCycleMode, 10)), this.closePopup(), this.popupRequestInProgress = !1
    }
    onPopupClose(t) {
        t.stopPropagation(), this.closePopup()
    }
    ...
    closePopup() {
        this.activeAreas = [], this.dispatchEvent(new CustomEvent("close"))
    }
    render() {
    ...
    renderSuctionMode() {
        if (this.activeCleaningMode == Ht.Mop) return W;
    ...
    renderMoppingMode() {
        if (this.activeCleaningMode == Ht.Vac) return W;
    ...
    fixModesIfNeeded() {
        qt.isSupportedSuctionMode(this.activeSuctionMode, this.activeCleaningMode) || (this.activeSuctionMode = this.activeCleaningMode == Ht.Mop ? Dt.Off : Dt.Turbo), qt.isSupportedMopMode(this.activeMopMode, this.activeCleaningMode) || (this.activeMopMode = this.activeCleaningMode == Ht.Vac ? Lt.Off : Lt.Moderate), qt.isSupportedRouteMode(this.activeRouteMode, this.activeCleaningMode) || (this.activeRouteMode = Wt.Standard)
    }
...
t([dt()], oe.prototype, "robot", void 0), t([dt()], oe.prototype, "areas", void 0), t([dt()], oe.prototype, "iconColor", void 0), t([pt()], oe.prototype, "popupRequestInProgress", void 0), t([pt()], oe.prototype, "activeCleaningMode", void 0), t([pt()], oe.prototype, "activeSuctionMode", void 0), t([pt()], oe.prototype, "activeMopMode", void 0), t([pt()], oe.prototype, "activeRouteMode", void 0), t([pt()], oe.prototype, "activeCycleMode", void 0), oe = t([at("custom-cleaning-popup")], oe);
...
let ie = class extends rt {
    ...
    constructor() {
        super(), this.popupActive = !1, this.iconColor = "#000", this.robot = new qt
    }
    setConfig(t) {
        this.config = function(t) {
            var e, o;
            if (!t) throw new Error(It("error.invalid_config"));
            if (!t.entity) throw new Error(It("error.missing_entity"));
            const i = {
                [Ht.VacAndMop]: {
                    suction: Dt.Balanced,
                    mop: Lt.Moderate,
        ...
        }(t), this.robot.setEntity(this.config.entity)
    }
    getCardSize() {
        return 3
    }
    ...
    onPopupShow(t) {
        t.stopPropagation(), this.popupActive = !0
    }
    onPopupClose(t) {
        t.stopPropagation(), this.popupActive = !1
    }
    render() {
        if (!this.hass || !this.config) return W;
        this.iconColor = getComputedStyle(document.documentElement).getPropertyValue("--state-icon-color").trim(), this.robot.setHass(this.hass);
    ...
    renderState(t) {
        ...
        if (!e) return It(`status.${t}`);
        const o = this.state(e);
        return t == o ? It(`status.${t}`) : It(`status.${t}`) + ". " + It(`reach_status.${o}`) + "."
    }
    renderPopup() {
        if (!(this.hass && this.config && this.config.areas && this.popupActive)) return W;
    ...
    renderErrors() {
        ...
        if (t) {
            const e = this.state(t),
                s = `vacuum_error.${e}`;
            o = "none" != e, o && (i = D`<div>${It("common.vacuum_error")}: ${It(s)}.</div>`)
        }
        let s = !1,
            r = W;
        if (e) {
            const t = this.state(e),
                o = `doc_error.${t}`;
            s = "ok" != t, s && (r = D`<div>${It("common.doc_error")}: ${It(o)}.</div>`)
        }
        return o || s ? D`<div class="errors">${i} ${r}</div>` : W
    }
    renderStats(t) {
        if (void 0 === t) return W;
        const e = (this.config.stats[t] || this.config.stats.default || []).map((({
            entity: t,
            attribute: e,
            scale: o,
            divide_by: i,
            ...
            if (!t && !e) return W;
            let n;
            if (t && e) n = this.getAttributeValue(this.hass.states[t], e);
            else if (e) n = this.getAttributeValue(this.hass.states[this.config.entity], e);
            else {
                if (!t) return W;
                n = this.state(t)
            }
            if (void 0 === n) n = "N/A";
                ...
                if (null != o || null != i) {
                    let t = parseFloat(n);
                    null != i && i > 0 && (t /= i), n = null != o ? t.toFixed(o) : t.toString()
                }
            }
    ...
    renderMode() {
        ...
        e != Dt.Off && t.push(Zt(e, 24, this.iconColor)), o != Lt.Off && t.push(Ft(o, 24, this.iconColor)), t.push(Kt(i, 24, this.iconColor));
    ...
    renderMopDrying() {
        ...
        if (!t) return W;
        if ("on" != t.state) return W;
        const e = Number(this.hass.states[this.sensor.mopDryingRemainingTime].state);
        return D`<div class="tip" @click="${()=>this.handleMore(this.sensor.mopDryingRemainingTime)}"><ha-icon icon="mdi:heat-wave"></ha-icon><span class="icon-title">${function(t){if(0===t)return"0s";const e=Math.floor(t/3600),o=Math.floor(t%3600/60);return(e>0?`${e}h `:"")+(o>0?`${o}min`:"").trim()}(e)}</span></div>`
    }
    renderBattery() {
        const t = this.hass.states[this.config.entity],
    ...
    getAreas() {
        const t = [];
        if (!this.config.areas) return t;
        for (let {
                area_id: e,
                roborock_area_id: o
            }
            of this.config.areas) {
    ...
    _getExistingSensorId(t) {
        for (let e of t)
            if (this.hass.states[e]) return e
    }
    getAttributeValue(t, e) {
        return t.attributes[e]
    }
...
t([dt({
    attribute: !1
})], ie.prototype, "hass", void 0), t([pt()], ie.prototype, "config", void 0), t([pt()], ie.prototype, "popupActive", void 0), ie = t([at("roborock-vacuum-card")], ie);
export {
    ie as RoborockVacuumCard
};